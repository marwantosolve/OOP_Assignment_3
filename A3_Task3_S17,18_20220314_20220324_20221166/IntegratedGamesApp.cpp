...
int main() {
    while (true) {
        ...
        if (op == 1) {
            ...
            cout << "Welcome to our \"3x3 X,O Game\" \n";
            Player *players[2];
            ...
            cout << "\nWe're sorry but our teammate didn't accomplish his work :( \n"
                    "So We don't have the game for now. Please Re-run and enjoy other Games :) \n";
            return 0;
        } else if (op == 3) {
            cout << "Welcome to our \"Pyramic X,O Game\" \n";
            Player* players[2];
            players[0] = new Player (1, 'x');
            cout << "Press 1 if you want to play with computer or 2 to play with your friend: \n";
            int c3; cin >> c3;
            ...
            if (c4 == 1) {
                ...
                cout << "\nIt's now Under Development in this version!... Coming Soon \n";
            } else {
                cout << "\nInvalid option!..., Please Re-Run and try again! \n";
                return 0;
            }
            system ("pause");
            break;
        } else if (op == 5) {
            cout << "\nThanks for playing our Games, hope you enjoyed it :) \n";
            return 0;
        } else {
            cout << "\nInvalid option!..., Please Re-Run and try again! \n";
            return 0;
